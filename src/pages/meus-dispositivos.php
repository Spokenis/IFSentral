            ...
            <ul class="order-1 order-md-3 navbar-nav navbar-no-expand ml-auto">
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        ...
                        <a href="meus-dispositivos.php" class="dropdown-item active"><i class="fas fa-microchip mr-2"></i> Meus Sensores</a>
                        <a href="configuracoes.php" class="dropdown-item"><i class="fas fa-cog mr-2"></i> Configurações</a>
                        <div class="dropdown-divider"></div>
                        <?php if (($_SESSION['profile'] ?? 'User') === 'Admin'): ?>
                        <a href="admin.php" class="dropdown-item"><i class="fas fa-user-shield mr-2"></i> Administração</a>
                        <div class="dropdown-divider"></div>
                        <?php endif; ?>
                        <a href="../auth/logout_api.php" class="dropdown-item"><i class="fas fa-sign-out-alt mr-2 text-danger"></i> Sair</a>
                    </div>
                </li>
            </ul>
        </div>
