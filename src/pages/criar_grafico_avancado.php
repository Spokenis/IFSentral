    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse order-3" id="navbarCollapse">
        <ul class="navbar-nav">
          ...
          <li class="nav-item"><a href="gerenciar-projeto.php?id=<?php echo $project_id_from_url; ?>" class="nav-link">Voltar</a></li>
        </ul>
      </div>
      <ul class="order-1 order-md-3 navbar-nav navbar-no-expand ml-auto">
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-right">
            <a href="logout_api.php" class="dropdown-item text-danger">
